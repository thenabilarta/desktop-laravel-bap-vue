...
namespace Modules\Dayparting\Http\Controllers;
...
class DaypartingController extends AppBaseController
{
    ...
    public function data()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://192.168.1.5/xibo-cms/web/api/daypart',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
