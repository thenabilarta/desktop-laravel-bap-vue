        ...
        <sui-table selectable celled v-else>
          ...
          <sui-table-body>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[3] &&
                previewProfileData.config[3].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[4] &&
                previewProfileData.config[4].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[10] &&
                previewProfileData.config[10].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[16] &&
                previewProfileData.config[16].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[18] &&
                previewProfileData.config[18].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[19] &&
                previewProfileData.config[19].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[20] &&
                previewProfileData.config[20].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[23] &&
                previewProfileData.config[23].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            <sui-table-row>
              ...
              >
              <sui-table-cell>{{
                previewProfileData.config[24] &&
                previewProfileData.config[24].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
            ...
            <sui-table-row>
              ...
              <sui-table-cell>{{
                previewProfileData.config[29] &&
                previewProfileData.config[29].value === 1
                  ? "true"
                  : "false"
              }}</sui-table-cell>
            </sui-table-row>
