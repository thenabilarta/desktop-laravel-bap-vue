...
namespace Modules\DisplayGroup\Http\Controllers;
...
class DisplayGroupController extends AppBaseController
{
    public function index()
    {
        ...
        return view('displaygroup::index');
    }
    ...
    public function data()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://192.168.1.5/xibo-cms/web/api/displaygroup',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
