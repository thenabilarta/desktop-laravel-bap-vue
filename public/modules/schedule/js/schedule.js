...
Component.options.__file = "modules\\schedule\\resources\\assets\\js\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-262887ff", Component.options)
  } else {
    hotAPI.reload("data-v-262887ff", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dayjs_plugin_weekday__ = __webpack_require__(109);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://127.0.0.1:8000/schedule/data', {
      ...
      return res.data.result.map(function (r) {
        ...
        _this.displaySchedule.push({
          title: r.title,
          start: __WEBPACK_IMPORTED_MODULE_1_dayjs___default.a.unix(r.start / 1000).format('YYYY-MM-DD-HH-mm'),
          end: __WEBPACK_IMPORTED_MODULE_1_dayjs___default.a.unix(r.end / 1000).format('YYYY-MM-DD-HH-mm'),
  ...
  methods: {
    ...
    createDaysForCurrentMonth: function createDaysForCurrentMonth(year, month, schedule) {
      return [].concat(_toConsumableArray(Array(this.getNumberOfDaysInMonth(year, month)))).map(function (day, index) {
        var displayExist = false;

        if (schedule.length > 0) {
          if (__WEBPACK_IMPORTED_MODULE_1_dayjs___default()(year + '-' + month + '-' + (index + 1)).format('YYYY-MM-DD') === schedule[1].displayDateEnd) {
            displayExist = true;
          }
        }

        if (schedule.length > 0) {
          if (__WEBPACK_IMPORTED_MODULE_1_dayjs___default()(year + '-' + month + '-' + (index + 1)).format('YYYY-MM-DD') === schedule[1].displayDateStart) {
            displayExist = true;
          }
        }
  ...
  computed: {
    ...
    calendarList: function calendarList() {
      return [].concat(_toConsumableArray(this.createDaysForPreviousMonth(this.INITIAL_YEAR, this.INITIAL_MONTH)), _toConsumableArray(this.createDaysForCurrentMonth(this.INITIAL_YEAR, this.INITIAL_MONTH, this.displaySchedule)), _toConsumableArray(this.createDaysForNextMonth(this.INITIAL_YEAR, this.INITIAL_MONTH)));
    },
            ...
            _c(
              ...
              _vm._l(_vm.calendarList, function(c, index) {
                return _c(
                  ...
                  [
                    c.displayExist
                      ? _c("sui-icon", { attrs: { name: "desktop" } })
                      : _vm._e(),
                    _vm._v(" "),
                    _c(
                      "span",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-262887ff", module.exports)
  }
}
